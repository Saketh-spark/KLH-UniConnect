...
const statsCards = [
  ...
  },
  {
    ...
    value: 120,
    description: 'Total students across classes',
        ...
        <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs uppercase tracking-[0.5em] text-slate-400">Faculty</p>
            </div>
          </div>
          <div className="flex items-center gap-6 text-sm">
            <div className="text-right">
              <p className="text-[0.6rem] uppercase tracking-[0.5em] text-slate-400">Role</p>
              <p className="text-base font-semibold text-slate-900">Faculty</p>
            </div>
            <div className="text-right">
